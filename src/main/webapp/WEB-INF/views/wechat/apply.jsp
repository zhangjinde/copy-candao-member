        ...
        <div class="content">
            ...
            <div class="content-padded">
                ...
                <form action="" method="post" class="J-apply-form">
                                ...
                                <div class="item-content">
                                    <div class="item-inner">
                                        ...
                                        <div class="item-input">
                                            <input type="number" name="phone"  id="phone" class="ui-ipt-text" maxlength="11" oninput="if(value.length>11)value=value.slice(0,11)" autocomplete="off"   placeholder="请输入手机号码">
                                            <i class="btn-em"></i>
                                        </div>
                                    ...
                                    <div class="item-inner">
                                        ...
                                        <div class="item-input">
                                            <div class="row">
                                                ...
                                                <div class="col-60"><a href="#" class="button button-light btn-get-code J-send-code disabled">获取验证码</a></div>
                                            </div>
                                        </div>
                            ...
                            <li>
                                <div class="item-content">
                                    <div class="item-inner">
                                        ...
                                        <div class="item-input">
                                            <input type="password" name="password" class="ui-ipt-text" maxlength="6" autocomplete="off" placeholder="6位数字密码">
                                            <i class="btn-em"></i>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <p><a href="javascript:void(0);"class="button button-fill button-big disabled J-btn-submit">下一步</a></p>
                    <p><a href="javascript:void(0)" onclick="window.location.href='./login'" class="button button-light btn-bind">已是会员？去绑定<span class="icon icon-right"></span></a></p>
                </form>
            </div>
        </div>
    </div>
...
<script>
    ...
    $(function(){
        ...
        $applyForm.find('input').bind('input',function(event){
            var me = $(this);
            if(me.length > 0) {
                ...
                success: function(result){
                    ...
                    if(result.code === '0') {
                        ...
                        if(result.data.Cardno.length == 12) {
                            ...
                            window.location.href ='./wxTips?msg=' + escape('加入会员成功') + '&time=' + '1000' + '&url=' + 'perfectInfo'  + '&type=success';
                        } else {
                            console.info('获取卡号失败');
                            $err.find('span').text('获取卡号错误');
                            $err.show();
                        }
