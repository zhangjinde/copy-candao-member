...
<head>
	...
	$(function() {
		...
		if (self != top) {
			window.parent.location.href = global_ctxPath + "/index";
		}
		var l="${j_username}";
		//如果账号输入框不为空，则聚焦到密码框
		if( $("#j_username").val() != ''){
...
<body>
	...
	<div class="ky-content">
		<img src="${ pageContext.request.contextPath}/images/bg.jpg" class="contentBj" alt="" width="1024px" height="362px"/>
		<div class="loginWrap main">
			<form method="post" action="${ pageContext.request.contextPath}/index/tenantLogin"
				class="form-signin" id="j_loginform">
				<h2 class="header">登录</h2>
				<c:if test="${not empty message }">
					<div class="alert alert-warning" id="error_msg">
				...
				<div class="row">
					<div class="textWrap clearfix">
						...
						<input type="text" name="username"
							id="j_username" class="input-block-level" placeholder="请输入租户账号"
				...
				<div class="row">
					<div class="textWrap clearfix">
						...
						<input type="password" class="input-block-level" name="password_show" id="j_password_show"
							tabindex="2" placeholder="密码" />
						<input type="hidden" class="input-block-level" name="password" id="j_password" />
					</div>
				</div>
				<div class="row">
					<div class="forgetPwd">
